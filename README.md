...
• 	Minimalistic neon‑themed interface

• 	Animated background rendered via Canvas

• 	Interactive project cards with 3D tilt, glare, and dynamic lighting

• 	Dual‑language support (Russian / English)

• 	Animated logo (pulse, glitch, scan‑line effects)
...
• 	CSS3 (animations, effects, 3D transforms)
...
The website supports two languages: Russian and English.
